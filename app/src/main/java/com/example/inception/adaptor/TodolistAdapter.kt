    ...
    override fun onBindViewHolder(holder: TodoHolder, position: Int) {
        ...
        holder.check_box.setOnClickListener {
            ...
            if(holder.check_box.isChecked == true) {
                ...
                //jika tidak, maka kita ubah status pada table menjadi 0
                dbHelper.UpdateTodoStatus(todos[position].id, 0)
                //hilangkan garis pada teks
        ...
        holder.delete_button.setOnClickListener {
            //panggil deleteTodo untuk menghapus baris data pada table_todo berdasarkan id
